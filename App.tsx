        ...
        <div className="overflow-hidden">
            ...
            <main>
                ...
                >
                    <Animated>
                        <p className="text-base sm:text-lg md:text-xl leading-relaxed mb-16 text-center max-w-6xl mx-auto text-balance">
                            Esta é a música gravada por artistas do sul do Brasil em 29 de setembro de 2025, celebrando o Dia Mundial dos Animais. Ouça e sinta a força da nossa mensagem de amor e proteção aos animais.
                        </p>
                    </Animated>
                    <Animated delay={100}>
                    ...
                    <div className="text-center max-w-4xl mx-auto mt-16">
                        <AnimatedTypewriter
                            lines={[
                                { text: "29 de setembro de 2025", className: "text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-brand-primary font-serif mb-10 drop-shadow-2xl tracking-wide md:tracking-wider lg:tracking-widest" },
                            ...
                            <div className="w-full">
                                <HorizontalScroll itemWidth="85vw" gap="1.5rem" showIndicators={true}>
                                    {(() => {
                                        ...
                                        const pages = [];
                                        for (let i = 0; i < content.agradecimento.artists.length; i += itemsPerPage) {
                            ...
                            <div className="w-full">
                                <HorizontalScroll itemWidth="85vw" gap="1.5rem" showIndicators={true}>
                                    {(() => {
                                        ...
                                        const pages = [];
                                        for (let i = 0; i < content.agradecimento.team.length; i += itemsPerPage) {
