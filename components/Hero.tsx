    ...
    return (
        <section id="home" className="h-screen flex items-center justify-center relative text-center text-white overflow-hidden">
            ...
            <div className="relative z-10 p-6 max-w-4xl mx-auto">
                <h1 className={`${baseTransition} delay-200 ${isLoaded ? loadedState : initialState} text-6xl md:text-8xl font-bold font-serif leading-tight mb-4 drop-shadow-lg`}>
                    {titleText}
                </h1>
                <p className={`${baseTransition} delay-500 ${isLoaded ? loadedState : initialState} text-3xl md:text-4xl font-light mb-2 font-serif italic text-brand-primary`}>
                    {subtitleText}
                </p>
                <p className={`${baseTransition} delay-700 ${isLoaded ? loadedState : initialState} text-2xl md:text-3xl max-w-2xl mx-auto drop-shadow-md mb-8`}>
